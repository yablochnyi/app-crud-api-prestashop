...
Route::group(['middleware' => ['auth', 'admin', 'verified']], function () {
    ...
    Route::get('update/price/all/prestashop', [\App\Http\Controllers\Prestashop\UpdateProductController::class, 'updateAllProductPriceOnPrestaShop'])->name('update.price.all.prestashop');
